...
void write_artifact_score()
{
    ...
    //judge standard
    outfile_artifact_judge << ",生暴爆数量,生暴爆,生暴爆(反应)数量,生暴爆(反应),攻暴爆数量,攻暴爆,攻暴爆(反应)数量,攻暴爆(反应),精暴爆数量,精暴爆,最大数量" << endl;
    ...
    for (int i = 0; i < 5; ++i)
        for (int j = 0; j < reinforced_artifact_list[i].size(); ++j)
        {
            ...
            if (reinforced_artifact_list[i][j]->level == 0)
                entry_num = attribute_data(round(entry_num.get("生命值")), round(entry_num.get("攻击力")), round(entry_num.get("防御力")), round(entry_num.get("元素精通")),
                                           round(entry_num.get("元素充能效率")), round(entry_num.get("暴击率")), round(entry_num.get("暴击伤害")), round(entry_num.get("伤害加成")),
                                           round(entry_num.get("抗性削弱")), round(entry_num.get("防御削弱")), round(entry_num.get("防御无视")), round(entry_num.get("治疗加成")), round(entry_num.get("护盾强效")));

            double max_acceptable_entry_num = 0;
            ...
            if ((i == 2 && (reinforced_artifact_list[i][j]->main.first != "生命值" && reinforced_artifact_list[i][j]->main.first != "元素充能效率")) ||
                (i == 3 && reinforced_artifact_list[i][j]->main.first.find("伤害加成") == string::npos) ||
                (i == 4 && (reinforced_artifact_list[i][j]->main.first != "暴击率" && reinforced_artifact_list[i][j]->main.first != "暴击伤害")))
                life_entry_judge = "FALSE";
            else
                max_acceptable_entry_num = max(max_acceptable_entry_num, life_entry_num);
            ...
            if ((i == 2 && (reinforced_artifact_list[i][j]->main.first != "生命值" && reinforced_artifact_list[i][j]->main.first != "元素精通" && reinforced_artifact_list[i][j]->main.first != "元素充能效率")) ||
                (i == 3 && reinforced_artifact_list[i][j]->main.first.find("伤害加成") == string::npos) ||
                (i == 4 && (reinforced_artifact_list[i][j]->main.first != "暴击率" && reinforced_artifact_list[i][j]->main.first != "暴击伤害")))
                life_react_entry_judge = "FALSE";
            else
                max_acceptable_entry_num = max(max_acceptable_entry_num, life_react_entry_num);
            ...
            if ((i == 2 && (reinforced_artifact_list[i][j]->main.first != "攻击力" && reinforced_artifact_list[i][j]->main.first != "元素充能效率")) ||
                (i == 3 && reinforced_artifact_list[i][j]->main.first.find("伤害加成") == string::npos) ||
                (i == 4 && (reinforced_artifact_list[i][j]->main.first != "暴击率" && reinforced_artifact_list[i][j]->main.first != "暴击伤害")))
                atk_entry_judge = "FALSE";
            else
                max_acceptable_entry_num = max(max_acceptable_entry_num, atk_entry_num);
            ...
            if ((i == 2 && (reinforced_artifact_list[i][j]->main.first != "攻击力" && reinforced_artifact_list[i][j]->main.first != "元素精通" && reinforced_artifact_list[i][j]->main.first != "元素充能效率")) ||
                (i == 3 && reinforced_artifact_list[i][j]->main.first.find("伤害加成") == string::npos) ||
                (i == 4 && (reinforced_artifact_list[i][j]->main.first != "暴击率" && reinforced_artifact_list[i][j]->main.first != "暴击伤害")))
                atk_react_entry_judge = "FALSE";
            else
                max_acceptable_entry_num = max(max_acceptable_entry_num, atk_react_entry_num);
            ...
            if ((i == 2 && (reinforced_artifact_list[i][j]->main.first != "元素精通" && reinforced_artifact_list[i][j]->main.first != "元素充能效率")) ||
                (i == 3 && reinforced_artifact_list[i][j]->main.first.find("伤害加成") == string::npos) ||
                (i == 4 && (reinforced_artifact_list[i][j]->main.first != "暴击率" && reinforced_artifact_list[i][j]->main.first != "暴击伤害")))
                mastery_entry_judge = "FALSE";
            else
                max_acceptable_entry_num = max(max_acceptable_entry_num, mastery_entry_num);
            ...
            outfile_artifact_judge << "," << life_entry_num << "," << life_entry_judge
                                   ...
                                   << "," << mastery_entry_num << "," << mastery_entry_judge
                                   << "," << max_acceptable_entry_num << endl;
        }
